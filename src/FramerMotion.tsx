  ...
  return (
    <div className="flex flex-col gap-10 overflow-x-hidden">
      ...
      <section className="flex flex-col gap-10 mb-10" ref={containerRef}>
        ...
        >
          This is a basic use on how to get up and running with Framer Motion
          with some TailwindCSS. Here,i learned how to use the few basics of
          animation.
        </motion.p>
        <motion.p
          className="text-slate-100 font-thin text-4xl w-1/2 mx-auto"
        ...
        >
          Had fun playing with Framer Motion. It is a very powerful library,
